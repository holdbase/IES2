...
(function ($, window) {
    ...
    function initWebUpload(item, options) {
        ...
        var webuploaderoptions = $.extend({
            ...
            // swf文件路径
            swf: applicationPath + '/Frameworks/BDUpload/lib/webuploader/Uploader.swf',

            // 文件接收服务端。
            server: applicationPath + '/Frameworks/BDUpload/FileUpload.ashx',
    ...
    $.fn.powerWebUpload = function (options) {
        ...
        $(ele).each(function (idnex, item) {
            ...
            if (typeof PowerJs != 'undefined') {
                PowerJs.Core.lazyLoad(applicationPath + "'/Frameworks/BDUpload/lib/webuploader/webuploader.css", function () { }, 'css');
                PowerJs.Core.lazyLoad(applicationPath + "'/Frameworks/BDUpload/lib/webuploader/webuploader.min.js", function () {
