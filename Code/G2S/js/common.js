...
$(function(){ 
	...
	var sHeight = $('.onlinediv').height();
	$('.onlinebox').css('top', (oHeight - sHeight - 100) / 2);
	$('.onlinediv').css('bottom', (oHeight - sHeight + 100) / 2);
	...
	$(".onlinediv li").hover(function () {
	    $(this).find(".curstrbox").show();
	}, function () {
	    $(this).find(".curstrbox").hide();
	});
